...
class ADCMeasurements():
    ...
    def __init__(
        ...
        self.set_calibration(1, 'C', self.bar4_to_temp)

    def adc_to_temp(self, adc):
        return 25 + (adc - (0.5/self._vref)*4095)/(2.654 * (2.5/self._vref))
    def bar4_to_temp(self, volts):
        return (410*volts) - 210
...
if __name__ == "__main__":
    ...
    device_meas.add_adc_pin(1)
    device_meas.add_adc_pin(2)
    device_meas.add_adc_pin(3)
    # device_meas.add_dac_pin(2)
